      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {socialPlatforms.map((platform, index) => (
            <Card
              key={platform.name}
              className="p-6 bg-card border-border hover:border-primary/50 transition-smooth animate-fade-up flex flex-col"
        ...
        <div className="max-w-2xl mx-auto animate-fade-up" style={{ animationDelay: '0.8s' }}>
          <Card className="p-8 bg-card border-border text-center hover:border-primary/50 transition-smooth">
